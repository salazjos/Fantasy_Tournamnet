...
Description: Barbarian.cpp - contains method
implementations for Barbarian class
********************************************/
#include <stdlib.h>
#include <time.h>
#include <iostream>
...
class constructor.
*****************************************/
Barbarian::Barbarian(int _armor, int _strength, string _name) : Character(_armor, _strength, _name){
    srand(time(nullptr));
}
...
******************************************/
int Barbarian::attack(Attack_Type &a_type, bool isCharm){

    if(isCharm){
        int random_num = (1 + rand() % 2)  -  1;
        if(random_num == 1){ //true, attack is 0, doesnt attack
            cout <<"\n";
...
******************************************/
void Barbarian::defense(int attackAmt, Attack_Type a_type,
